      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap">
          <div className="w-full md:w-4/12">
            ...
            <div className="mt-6 flex gap-2">
              <a href="https://x.com/thecuredesk" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.instagram.com/thecuredesk/" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.linkedin.com/in/thecuredesk-252973298/" target="_blank" rel="noreferrer">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 md:justify-between">
          ...
          <div className="text-center">
            <a href="https://www.vidhema.com" target="_blank" className="font-normal text-gray-600 transition-colors hover:text-primary">
              © Vidhema
            </a>
          </div>
        </div>
